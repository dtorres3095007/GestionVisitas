...
<body style="display: none" class="opcionesVisitantes">
  <div class="opciones opcionesVisitantes">
    ...
    <div class="operaciones">
      <button type="button" id="Recargar" class="btn btn-link active"><span class="smodificar glyphicon glyphicon-refresh"
          title="Recargar" data-toggle="popover" data-trigger="hover"></span></button>

      <button id="agregar" type="button" class="btn btn-link active btnAgregar" data-toggle="modal" data-target="#myModal"><span
          class="sagregar glyphicon glyphicon-floppy-disk" title="Agregar Visitante" data-toggle="popover" data-trigger="hover"></span></button>
      <button id="eliminar" type="button" class="btn btn-link active btnElimina"><span class="seliminar glyphicon glyphicon-remove"
          title="Eliminar Visitante" data-toggle="popover" data-trigger="hover"></span></button>
      <button id="modificar" type="button" class="btn btn-link active btnModifica"><span class="smodificar glyphicon glyphicon-wrench"
          title="Modificar Visitante" data-toggle="popover" data-trigger="hover"></span></button>
      <button type="button" id="CambiarTabla" class="btn btn-link active  btnCambiaTabla"><span class="smodificar glyphicon glyphicon-random "
          title="Cambiar Tabla" data-toggle="popover" data-trigger="hover"></span></button>
      <button class="btn btn-link active bntLectura"><span class="smodifica glyphicon glyphicon-eye-open " title="Solo Lectura"
          data-toggle="popover" data-trigger="hover"></span></button>
    ...
    <div class="moduloname">
      <h5>Administracion de Visitantes</h5>
    </div>
  </div>
        ...
        <div class="modal-body " id="bodymodal">
          <div class="row2 ">
            ...
            <table class="table" id="datosvisi" style="width: 500px; margin:  0 auto">
              <tr>
                <th class="filaprincipal" colspan="3" style="color: #990000; text-align: center">Datos del Visitante</th>
              </tr>
              <tr>
                <td rowspan="9" class="fotoVisitante" style="width: 150px;text-align: center"></td>
              </tr>
              <tr>
                <td class="primero">Nombres</td>
                <td class="nombrevisitante"></td>
              </tr>
              <tr>
                <td class="primero">Apellidos</td>
                <td class="apellidovisitante"></td>
              </tr>
              <tr>
                <td class="primero">Tipo identificacion</td>
                <td class="tipoidvisitante"></td>
              </tr>
              <tr>
                <td class="primero">Identificacion</td>
                <td class="identificacionevisitante"></td>
              </tr>
              <tr>
                <td class="primero">Correo</td>
                <td class="correovisitante"></td>
              </tr>
              <tr>
                <td class="primero">Celular</td>
                <td class="celularvisitante"></td>
              </tr>
          ...
          <div class="form-group col-md-6">
            <div class="input-group">
              ...
              <span class="input-group-addon pointer" title="Buscar Persona" data-toggle="popover" data-trigger="hover"
                id="btn_buscar_visitante"><span class="glyphicon glyphicon-search"></span></span>
            </div>
          </div>
          <thead class="ttitulo ">
            <tr class="filaprincipal">
              <td class="" id='nombrevisitante'>Nombre Completo</td>
              <td class="">Tipo Identificacion</td>
              ...
              <div class="row">
                ...
                <div class="TomarFoto">
                  <table class="table">
                    <thead class="ttitulo ">
                      <tr class="filaprincipal">
                        <td colspan="2"> Foto Visitante</td>
                      </tr>
                    </thead>

                    <tr>
                      <td class="video"><video id="video" autoplay="autoplay"></video></td>
                      <td class="canvas"><canvas id="canvas" width="300" height="208"></canvas></td>
                    </tr>

                    <tr>
                      <td colspan="2"> <span id="foto" class="btn btn-danger active form-control">
                          Tomar Foto!
                        </span></td>
                    </tr>
                  </table>
                ...
                <input type="text" name="apellido" id="txtApellido" class="form-control inputt2" placeholder="Primer Apellido"
                  required>
              ...
              <div class="row divmodifica">
                ...
                <div class="TomarFoto">
                  <table class="table" style="">
                    ...
                    <tr>
                      <td class="imagenactual"></td>
                      <td class="videomodi"><video id="videomodi" autoplay="autoplay"></video></td>
                      <td class="canvasmodi"><canvas id="canvasmodi" width="300" height="208"></canvas></td>
                    </tr>

                    <tr>
                      <td colspan="2"> <span id="fotomodi2" class="btn btn-danger active form-control">
                          Nueva Foto!
                        </span></td>
                    </tr>
                  </table>
                ...
                <input min="1" type="number" name="identificacion" id="txtIdentificacionModi" class="form-control inputt"
                  placeholder="No. Identificación" required>

                <input type="text" name="apellido" id="txtApellidoModi" class="form-control inputt2" placeholder="Primer Apellido"
                  required>

                <input type="text" name="segundoapellido" id="txtsegundoapellidomodi" class="form-control inputt2"
                  placeholder="Segundo Apellido" required>

                <input type="text" name="nombre" id="txtNombreModi" class="form-control inputt2" placeholder="Primer Nombre"
                  required>
                <input type="text" name="segundonombre" id="txtSegundoNombremodi" class="form-control inputt2"
